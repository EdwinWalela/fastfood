...
const MenuListItem = (props: { item: MenuItem; index: number }) => {
	const dispatch = useAppDispatch();

	function handleAddToCart(index: number) {
		dispatch(addToCart({ id: index, category: '' }));
	}

	return (
		<div className="shadow-md bg-white py-6 mx-8 my-4 text-center w-80 rounded-lg">
			<h3 className="text-left bg-black text-white pl-6 py-1 rounded-tr-md rounded-br-md w-1/3">
				KES {props.item.price}
			</h3>
